# Kelpa - A miniature server development framework
...
©¦      ©¸©¤Debug -- test  #Simple http server demo 
 |          
©À©¤Build                     #Intermediate files produced by cmake
©À©¤Config                    #Contains a json file for config
©À©¤Examples              #Example programmes
©À©¤Include               #head files
©À©¤Lib                       #libraries(static dynamic)
©À©¤Src                       #source code
©¦  ©À©¤Compress           #Compressing module
©¦  ©À©¤Configure          #Configure loading and parsing module
©¦  ©À©¤Coroutine          #Async coroutine module
©¦  ©À©¤CppJson            #Json file parsing and dumping module
©¦  ©À©¤IOSchedule         #IO sheduling module
©¦  ©À©¤Journal            #Logging module
©¦  ©À©¤Serde              #Serializing module
©¦  ©À©¤Thread             #Concurent module
